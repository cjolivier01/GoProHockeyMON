...
def main():
    ...
    refs = [obj for obj in bpy.context.scene.objects if obj.name.startswith('REFERENCE_ONLY_')]
    ...
    render('mission1_expanded_organizer.png', (0, 0, 500), (0, 0, 140), 270,
           [('COIL + TWO REMOTES + SPARE STORAGE', -124, 98, 4.6),
            ('154 mm coil allowance', -98, 5, 3.9),
            ('42 mm deep', -77, -3, 3.6),
            ('Spare storage', 54, 55, 3.1), ('56.5 x 57 mm', 54, 48, 3.1),
            ('Remote 2', 61, -4, 3.2), ('Remote 1', 61, -57, 3.2),
            ('Remote cells: 42 x 48 x 17 mm, including button clearance', -124, -98, 3.5)])
    clear()
